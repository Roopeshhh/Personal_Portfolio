                ...
                <div className="grid grid-cols-1 gap-12">
                    {projects.map((project) => {
                        ...
                        return (
                            <div
                                key={project.id}
                                className="glass-card rounded-3xl p-8 lg:p-10 border border-white/10 relative overflow-hidden group transition-all duration-300 hover:border-aurora-cyan/30"
                            >
                          ...
                          // Key Technical Features
                                        ...
                                        {/* Tech Stack Pills & Dynamic Status / Action Bar */}
                                        <div>
                                    ...
                                    <div className="lg:col-span-5 w-full">
                                        <div className="rounded-2xl bg-black/60 border border-white/10 p-5 shadow-2xl relative overflow-hidden">
