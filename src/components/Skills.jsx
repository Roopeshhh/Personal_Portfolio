...
export default function Skills() {
    ...
    return (
        <section id="skills" className="relative py-24 px-4 sm:px-6 bg-canvas-elevated/40">
            <div className="max-w-6xl mx-auto">
                ...
                {/* 6 Category Grid with Staggered Cascade Delays */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {skills.map((cat, idx) => (
                        <ScrollReveal key={idx} delay={idx * 100} className="h-full">
                            <div className="glass-card rounded-3xl p-7 border border-white/10 relative overflow-hidden group hover:border-white/20 transition-all duration-300 flex flex-col justify-between h-full">
                                <div>
                                    {/* Category Header */}
